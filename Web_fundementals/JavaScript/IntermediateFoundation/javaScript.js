...
function arrayNthToLast(arr,index){
...
console.log(arrayNthToLast(arr,8));
...
function doubleTrouble(arr){
    var origingLen = arr.length;
     arr.length *=2;
    for (var i = origingLen -1; i >=0;i--){
        arr[i*2 + 1 ] = arr[i];
        arr[i*2] = arr[i];
    }
    return arr;
